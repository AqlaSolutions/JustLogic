...
public class JLGuiLayoutHorizontalSlider : JLExpression
{
    ...
    {
        return GUILayout.HorizontalSlider(Value.GetResult<System.Single>(context), LeftValue.GetResult<System.Single>(context), RightValue.GetResult<System.Single>(context), Options.GetResult<GUILayoutOption>(context));
    }
}
